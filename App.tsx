            ...
            async (position) => {
                try {
                    ...
                    if (locationName) {
                        ...
                        alert(
                            "Could not determine your location. Please set it manually.",
                        );
                    }
                } catch (error) {
                    console.error(
                        "Error getting jurisdiction from coords:",
                        error,
                    );
                    alert(
    ...
    return (
        <>
            <DisclaimerModal
                ...
                onClose={handleAcknowledgeDisclaimer}
            />
            <div className="flex flex-col h-screen bg-transparent text-white font-sans">
                ...
                <footer className="bg-gray-900/60 p-3 text-center text-xs text-gray-400 border-t border-gray-700/50">
                    Disclaimer: This is an AI-powered tool for informational
                    purposes only and does not constitute legal advice. Always
